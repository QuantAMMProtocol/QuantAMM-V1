...
contract E2eSwapQuantAMMInterpolationTest is E2eSwapTest, QuantAMMWeightedPoolContractsDeployer {
    ...
    function _createPool(address[] memory tokens, string memory label) internal override returns (address) {
        ...
        address poolAddress = address(createQuantAMMPoolInterpolating(tokens, label, rateProviders, vault, lp));
