...
contract E2eBatchSwapQuantAMMInterpolatingWeightedTest is QuantAMMWeightedPoolContractsDeployer, E2eBatchSwapTest {
    ...
    function _createPool(address[] memory tokens, string memory label) internal virtual override returns (address) {
        ...
        address newPool = address(createQuantAMMPoolInterpolating(tokens, label, rateProviders, vault, lp));
