...
contract UpdateWeightRunner is IUpdateWeightRunner {
    ...
    function _calculateMultiplerAndSetWeights(CalculateMuliplierAndSetWeightsLocal memory local) internal {
        ...
        int256[][] memory splitWeightsAndMultipliers = _splitWeightAndMultipliers(targetWeightsAndBlockMultiplier);
    ...
    function setWeightsManually(
        ...
        int256[][] memory splitWeightsAndMultipliers = _splitWeightAndMultipliers(_weights);
        IQuantAMMWeightedPool(_poolAddress).setWeights(splitWeightsAndMultipliers, _lastInterpolationTimePossible);
