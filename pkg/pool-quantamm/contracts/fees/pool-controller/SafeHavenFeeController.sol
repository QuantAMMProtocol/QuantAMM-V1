...
contract SafeHavenFeeController { 
    ...
    address public immutable vault = 0xbA1333333333a1BA1108E8412f11850A5C319bA9;


    address public immutable pool = 0x6B61D8680C4F9E560c8306807908553f95c749C5;
    ...
    function setFixedFees() external {        
        IQuantAMMWeightedPool.QuantAMMWeightedPoolDynamicData memory poolData = IQuantAMMWeightedPool(pool).getQuantAMMWeightedPoolDynamicData();
